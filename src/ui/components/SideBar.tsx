  ...
  return (
    <div>
      <div className="w-48 h-screen">
        <div className="h-full pt-16 px-3 py-4 overflow-y-auto bg-gray-800 dark:bg-gray-800 dark:text-white text-white">
          <ul className="flex flex-col space-y-2 text-md">
            <SideBarItem 
              title="Dashboard"
              imageComponent={
                <svg className="w-6 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 18">
            ...
            <SideBarItem
              title="Cuentas"
              imageComponent={
                <svg className="w-6 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 14">
