    ...
    <div>
      <div className="w-sideBar h-screen">
        <div className="h-full pt-4xl px-sm overflow-y-auto bg-gray-800 text-white">
          <ul className="flex flex-col space-y-xsm text-xl justify-center items-center">
            <SideBarItem
              to={"/"}
              title="Dashboard"
              imageComponent={
