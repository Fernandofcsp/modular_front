...
export const AccountPage = () => {
	...
	const updateAccount = async (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
	...
	return (
		<Layout>
			<form className="w-9/12 mt-sm">
				...
				{
					errors.length > 0 &&
					errors.map((error) => <div className="mb-sm"><p key={error} className="text-red-600 text-end">{error}</p></div>)
				}
